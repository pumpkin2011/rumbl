defmodule Rumbl.AuthTest do
  ...
  test "login with password not match", %{conn: conn} do
    _ = insert_user(username: "max", password: "secret")
    assert {:error, :unauthorized, _conn} = Auth.login_by_username_and_pass(conn, "max", "123", repo: Repo)
  end
