defmodule Rumbl.VideoControllerTest do
  ...
  @tag login_as: "max"
  test "creates user and redirects", %{conn: conn, user: user} do
  ...
  @tag login_as: "max"
  test "does not create video and renders errors when ivalid", %{conn: conn} do
  ...
  @tag login_as: "max"
  test "authornizes actions against access by other users", %{user: owner, conn: conn} do
